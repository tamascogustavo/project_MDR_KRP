...
def main():
    ...
    df_major_classes = build_class_df(df_info, all_vir_classes, plasmid_vir_metadata)
    df = pd.DataFrame.from_dict(df_major_classes, orient='index', columns=['fyu', 'irp', 'mgt', 'pil', 'xcp', 'xcpA/pil', 'ybt'])
    #df = df.transpose()
